...
public class RolePermissionServiceImpl implements RolePermissionService {
    ...
    public RolePermission grantPermission(RolePermission mapping) {
        ...
        Permission perm = permRepo.findById(mapping.getPermission().getId())
                .orElseThrow(() -> new BadRequestException("Invalid permission"));

        if (!role.isActive() || !perm.isActive()) {
